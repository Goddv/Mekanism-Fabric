...
public record ConfigurableHeightRange(Supplier<HeightShape> shape, ConfigurableVerticalAnchor minInclusive, ConfigurableVerticalAnchor maxInclusive,
    ...
    public static ConfigurableHeightRange create(IMekanismConfig config, IConfigBuilder builder, OreVeinConfigTranslations translations, BaseOreConfig baseConfig) {
